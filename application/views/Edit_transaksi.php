...
<body background="image/Di.jpg">
    ...
    <div class="container">
        <div class="col-md-6">
            ...
            foreach ($menu as $x) {
            ?>
                <form action="<?php echo base_url('login/updateTransaksi'); ?>" method="POST">
        ...
        <input type="textbox" name="id_menu" class="form-control" value="">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Pesanan</label>
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="id_pesanan" name="id_pesanan" value="<?php echo $x->id_pesanan ?>">
                            <input type="text" class="form-control" id="nama_pesanan" name="nama_pesanan" value="<?php echo $x->nama_pesanan ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="jumlah" name="jumlah" value=" <?php echo $x->jumlah ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="total_harga" name="total_harga" value=" <?php echo $x->total_harga ?>">
                        </div>
                    </div>
