...
<body background="../image/D.jpg">
  ...
  <div class="container">
    <div class="col-md-6">
      <form action="<?php echo base_url('login/insertmeja'); ?>" method="POST">
  ...
  <div class="col-md-12">
    <table class="table">
      ...
      <tbody>
        <?php
        $query = $this->m_login->getdata('meja');
        $no = 1;
        ...
        ?>
          <tr>
            ...
            <td>
              <font color="ffffff"><?php echo $data->nama_meja; ?>
            </td>
            <td>
              <form method="POST" action="<?php echo base_url('login/editmeja'); ?>">
                <a href="<?php echo base_url('login/editmeja/' . $data->id_meja) ?>">Edit</a>
                <a href="<?php echo base_url('login/hapusmeja/' . $data->id_meja) ?>">Hapus</a>
            </td>
          </tr>
        <?php
        }
